...
mobile(x);
x.addListener(mobile); // let speaker_html = (name,work,project,twitter,url,des,info) => {
//    let html =  `
//     <!DOCTYPE html>
//     <html lang="en">
//     <head>
...
let speakers = document.querySelectorAll('.speaker-card'); // let speakers_mobile = document.querySelectorAll('.speaker-circ')
...
speakers.forEach(element => {
  element.addEventListener('click', () => {
    ...
    console.log(name);
    window.location.href = `/src/pages/${name.replace(/ /g, '')}.html`; // fetch(url)
    // .then((resp) => {
    //     resp.json().then((data) => {
