...
let sessionEntry = (title, name) => {
  ...
  for (let i = 1; i < name.length; i++) {
    ...
    if (name[i][Object.keys(name[i])]) {
      let d = new Date(name[i][Object.keys(name[i])][1]).toUTCString(); // d = moment(d)
...
},{"../node_modules/@glidejs/glide":1,"./apiKey":9,"jquery":2,"jump.js":3,"moment-timezone":5,"slick-carousel":8}]},{},[10]);
