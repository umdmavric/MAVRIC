...
`;
let url = `https://api.airtable.com/v0/appiwCrmeV2rljaOH/Speakers?api_key=${_apiKey.default.apikey}`; // let speaker_html = (name,work,project,twitter,url,des,info) => {
//     let html =  `
//      <!DOCTYPE html>
//      <html lang="en">
//      <head>
  ...
  if (width.matches) {
    ...
    fetch(url).then(resp => {
      resp.json().then(data => {
        ...
        console.log(speakers); // let speakers_mobile = document.querySelectorAll('.speaker-circ')
